                        ...
                        <ul class="site-menu js-clone-nav d-none d-md-block">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown" style="list-style-type: none;">
                                    <form action="MainController" method="POST">
                                        <li><a href="SearchCategoriesController?category=Milk" class="d-flex">Milk</a></li>
                                        <li><a href="SearchCategoriesController?category=Cooky" class="d-flex">Cooky</a></li>
                                        <li><a href="SearchCategoriesController?category=Yogurt" class="d-flex">Yogurt</a></li>
                                        <li><a href="SearchCategoriesController?category=Cake" class="d-flex">Cake</a></li>
                                    </form>
                                </ul>
                            </li>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12" >
                            <div class="site-blocks-table">
                                <table class="table table-bordered border" style="background-color: white; border-radius: 5px;">
                                    <thead>
                                        <tr>
                                    ...
                                    <form class="col-md-12"  action="MainController" method="POST">    
                                        <tr>
                                            ...
                                            <td class="product-name">
                                                <h2 class="h5 text-black"><%=cart.getIdProduct()%></h2>
                                            </td>
                                            <td><%=cart.getPrice()%></td>
                                            <td>
                                                <div class="input-group mb-3" style="max-width: 120px;">
                                                    <div class="row">
                                                        <div class="col-md-9"> 
                                                            ...
                                                            <input class="form-control" type="number" name="quantity"  value="<%=cart.getQuantity()%>">
                                                        </div>
                                                        <div class="col-md-3">
                                            ...
                                            <td> 
                                                <input type="hidden" name="cartId" value="<%=cart.getCartId()%>">
                                                <button name="action"value="Remove" class="btn btn-danger btn-sm">Delete</button>
                                            </td>
                                        </tr>
                                    </form>    
                                    <% } %>
