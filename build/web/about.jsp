                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="block-16">
                                <figure>
                                    <img src="images/Mochi.jpg" alt="Image placeholder" class="img-fluid rounded">
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="site-section-heading pt-3 mb-4">
                                <h2 class="text-black">Welcome to Mochi Milk!</h2>
                            </div>
                            <p>We are glad for your attention.</p>
                            <p>We have a lot of delicious milk and cake. Let enjoy them!!!</p>
