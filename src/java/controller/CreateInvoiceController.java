...
public class CreateInvoiceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            float totalDiscount= Float.parseFloat(request.getParameter("totalAfterDiscount"));
            
            InvoiceDTO invoice= new InvoiceDTO(invId, userID, dateBuy, gmail, address, total, discount, totalDiscount);
