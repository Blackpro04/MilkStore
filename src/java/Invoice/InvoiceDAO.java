...
public boolean createInvoice(InvoiceDTO invoice) throws ClassNotFoundException, SQLException {
    String sql = "INSERT INTO tblInvoice (invId, userID, dateBuy, gmail, address, total, discount, totalDiscount) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    try {
        ...
        if(connection != null){
            ...
            ps.setFloat(7, invoice.getDiscount());
            ps.setFloat(8, invoice.getTotalDiscount());
